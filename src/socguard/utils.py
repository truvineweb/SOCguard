...
def parse_sha256_sidecar(path: str) -> str | None:
    """
    Accepts common formats (Windows sidecar may contain 'SHA256: <hash>').
    """
    try:
...
def ps_to_encoded(ps: str) -> str:
    """Return Base64 for PowerShell -EncodedCommand (UTF-16LE)."""
    import base64
